"""
PodcastAI — Podcast transcription, summarization, and clip extraction
...
class Router:
    """Cost- and latency-aware model router for PodcastAI."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="PodcastAI: Podcast transcription, summarization, and clip extraction")
